...
class SpawnAgentTool(Tool):
    name = "spawn_agent"
    description = (
        "Start a managed Willow subagent in the current runtime. The subagent "
    ...
    def run(
        ...
        from willow.subagents import subagent_summary
...
class WaitAgentTool(Tool):
    name = "wait_agent"
    description = (
        "Wait for a managed Willow subagent update, completion, or current "
...
class CloseAgentTool(Tool):
    name = "close_agent"
    description = (
        "Request closure of a managed Willow subagent. Active provider calls are "
